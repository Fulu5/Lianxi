...
(function (root, factory) {
    ...
    var Animate = function(userOptions) {
        ...
        if (this._isType('Array', this.options.offset)) {
            ...
            //做了妥当的防呆处理，最糟糕的情况也不会出现空置，不过处理可以更稳妥一点，做一个数值校验
